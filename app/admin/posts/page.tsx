...
import { Plus, Pencil, Trash2, Search, ArrowLeft, FileText, Eye } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {filteredItems.length > 0 ? (
                    ...
                    <div className="rounded-3xl border-2 border-dashed border-primary/10 bg-card/20 backdrop-blur-sm px-8 py-20 text-center text-muted-foreground">
                        ...
                        <p className="text-xs">
                            {searchTerm || categoryFilter !== "all" || statusFilter !== "all" ? "Try a different search or filter" : "Add your first blog post to see it here"}
                        </p>
                    </div>
                )}
            </div>
